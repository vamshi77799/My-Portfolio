...
csv_path = os.path.join(script_location, "numbers", "NACA 4412 copy.csv")
...
for i,m in zip(xl_,yl_):
    ...
    yl1_.append(w)
# Angle attack = 0°
fig, a=plt.subplots(nrows=2,ncols=2,figsize=(20,15),dpi=50)
a[0,0].plot(x_values,y_values,'--',markersize=3,c='black',label="Mean Camber Line")
a[0,0].set_title("NACA 4412",fontsize=20,color='red')
...
a[0,1].set_title("NACA 4412",fontsize=20,color='red')
...
a[1,0].set_title("NACA 4412",fontsize=20,color='red')
...
a[1,1].set_title("NACA 4412", fontsize=20, color='red')
